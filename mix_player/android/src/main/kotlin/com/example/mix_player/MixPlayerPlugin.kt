...
import com.example.mix_player.models.BetterEventChannel
...
class MixPlayerPlugin: FlutterPlugin, MethodCallHandler {
 ...
 private fun setupEvent(playerId:String){
  ...
  override fun onMethodCall(@NonNull call: MethodCall, @NonNull result: Result) {
    ...
    if (call.method == "init") {
      ...
      System.out.println("cccza001")
        DownaloadServices(this,request["request"] as List<String>)
