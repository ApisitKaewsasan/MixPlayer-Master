...
public class AudioTool {
     ...
     * @param onCompleteCallback lambda with result audio
     */
    public  AudioTool mixAudios(String[] audios,String outputPath, OnFileComplete onCompleteCallback) throws IOException{
        FileManager.validateOutputFile(outputPath);
        ...
        String command = String.format(Locale.US,
                "%s -filter_complex amerge=inputs=%d -ac %d %s",
                mixPath,audios.length,audios.length,outputPath
        );
